...
from src.utils.config import get_codeql_path, SUPPORTED_LANGUAGES
...
def analyze_pipeline(
    ...
    Args:
        ...
        local_repo_folder: Optional path to local repositories to use as fallback.
...
def main_analyze() -> None:
    ...
    Usage:
        python src/pipeline.py [repo] [--language LANG] [--local-repo-folder /repos/mylocalrepo]
    """
